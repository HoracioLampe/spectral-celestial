...
description: Blockchain smart contract specialist for Solidity, EVM, security patterns, and gas optimization. Use when "smart contract, solidity, ethereum, evm, contract, web3, gas optimization, upgradeable contract, reentrancy, solidity, ethereum, smart-contracts, evm, web3, blockchain, defi, nft, security, gas" mentioned.
---
