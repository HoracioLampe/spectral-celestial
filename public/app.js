...
// ============================================
// BATCH COMPLETION SUMMARY & DOWNLOAD
// ============================================
...
window.showBatchCompletionSummary = async function (batchId) {
    try {
        ...
        document.getElementById('summaryBatchName').textContent = batch.batch_number || 'Sin nombre';
...
window.downloadBatchReceipt = async function () {
    ...
    try {
        ...
        link.setAttribute('download', `Batch_${batchId}_${currentBatchSummary.batch_number || 'Recibo'}_${new Date().toISOString().split('T')[0]}.csv`);
